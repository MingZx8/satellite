...
def main():
    ...
    # cfg.data.test.ann_file = '/media/ming/data/dota_1024/test1024/DOTA_test1024.json'
    # cfg.data.test.img_prefix = '/media/ming/data/dota_1024/test1024/images'
    cfg.data.test.ann_file = args.annfile
    cfg.data.test.img_prefix = args.imgprefix
